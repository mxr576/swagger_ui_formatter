...
namespace Drupal\Tests\swagger_ui_formatter\Unit {
  ...
  final class SwaggerUiLibraryDiscoveryTest extends UnitTestCase {
    ...
    /**
     * Tests with invalid package.json.
     */
    public function testWithInvalidPackageJson(): void {
      $this->setUpLibraryVersionTest();
    ...
    /**
     * Tests version not found in package.json.
     */
    public function testVersionNotFoundInPackageJson(): void {
      $this->setUpLibraryVersionTest();
    ...
    /**
     * Tests version is not supported in package.json.
     */
    public function testVersionIsNotSupportedInPackageJson(): void {
      $this->setUpLibraryVersionTest();
